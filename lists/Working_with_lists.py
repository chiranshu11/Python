...
#to access the element present inside the list of element list
#take alist variable and store that element list in it
#and acces through it
list1=list_with_lists[2]
print (list1[0])
